        ...
        <div className="bg-[#0d2238] text-white pt-24 pb-16 lg:pt-32 lg:pb-24">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-white/70 max-w-2xl text-lg leading-relaxed">
              Discover the absolute best culinary experiences, third-wave
              specialty espresso bars, street food stalls, and student dining
              spots in Township.
            </p>
          </div>
        </div>
          ...
          {filtered.length > 0 ? (
                    ...
                    <div className="border-t border-border pt-4 mt-auto">
                      <div className="space-y-1.5 text-[11px] text-muted mb-4">
                        <div className="flex items-center gap-1.5">
                          ...
                          <span>Town Centre, Township</span>
                        </div>
                        <div className="flex items-center gap-1.5">
                          <Clock className="w-3.5 h-3.5 text-muted shrink-0" />
                          <span>Daily: 8:00am - 10:00pm</span>
                        </div>
                      </div>
                      ...
                      <div className="flex flex-wrap gap-1">
                        {spot.tags?.slice(0, 3).map((tag) => (
                          <span
                            key={tag}
                            className="px-2 py-0.5 bg-orange-50 text-orange-700 text-[10px] font-medium rounded"
                          >
                            {tag}
                          </span>
                        ))}
            ...
            <div className="text-center py-12 bg-surface rounded-xl border border-border">
              <p className="text-muted text-base">
                No food spots found matching your search.
              </p>
              <button
