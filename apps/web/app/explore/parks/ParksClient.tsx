        ...
        <div className="bg-[#0d2238] text-white pt-24 pb-16 lg:pt-32 lg:pb-24">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-white/70 max-w-2xl text-lg leading-relaxed">
              Explore lush green spaces, riverside trails, botanical gardens, and outdoor sports fields available across Township.
            </p>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="flex flex-col sm:flex-row gap-4 items-center justify-between border-b border-border pb-6 mb-8">
            <h2 className="text-xl font-bold text-foreground">
              Parks & Green Spaces ({filtered.length})
            </h2>
            <div className="relative w-full sm:w-80">
              ...
              <input
                type="text"
                placeholder="Search parks, trails & nature..."
                value={searchQuery}
                    ...
                    <div className="border-t border-border pt-4 mt-auto">
                      <div className="space-y-1.5 text-[11px] text-muted mb-4">
                        <div className="flex items-center gap-1.5">
                          ...
                          <span>Riverside District, Township</span>
                        </div>
                        <div className="flex items-center gap-1.5">
                      ...
                      <div className="flex flex-wrap gap-1">
                        {spot.tags?.slice(0, 3).map((tag) => (
                          <span
                            key={tag}
                            className="px-2 py-0.5 bg-emerald-50 text-emerald-700 text-[10px] font-medium rounded"
                          >
                            {tag}
                          </span>
                        ))}
