...
const categories: { id: Category; label: string; icon: React.ElementType; link: string }[] = [
  { id: "all", label: "All Institutions", icon: Landmark, link: "/institutions" },
  { id: "education", label: "Education & Colleges", icon: GraduationCap, link: "/institutions/universities" },
  { id: "health", label: "Health & Medical", icon: Stethoscope, link: "/institutions/hospitals" },
  { id: "government", label: "Government Offices", icon: Landmark, link: "/institutions/government" },
];
      ...
      <main className="bg-background min-h-screen">
        ...
        <div className="bg-[#0d2238] text-white pt-24 pb-16 lg:pt-32 lg:pb-24">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-white/70 max-w-2xl text-lg leading-relaxed">
              Find contact details, operational hours, services, and directions for every major education, healthcare, and public service facility in the district.
            </p>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="flex flex-col md:flex-row gap-4 items-center justify-between border-b border-border pb-6 mb-8">
            {/* Category tabs */}
            <div className="flex flex-wrap gap-2 w-full md:w-auto" role="tablist" aria-label="Institution categories">
          ...
          {filtered.length > 0 ? (
              ...
              {filtered.map((inst) => (
                <article
                  ...
                  className={`group bg-surface rounded-xl border overflow-hidden hover:shadow-lg hover:-translate-y-0.5 transition-all duration-200 ${
                    inst.featured ? "border-primary/25 ring-1 ring-primary/10" : "border-border"
                  }`}
                >
                  {/* Image */}
            ...
            <div className="text-center py-12 bg-surface rounded-xl border border-border">
              <p className="text-muted text-base">No institutions found matching your search.</p>
              <button
