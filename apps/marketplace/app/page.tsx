                ...
                >
                  ...
                  <div className="relative h-56 w-full overflow-hidden bg-muted">
                    ...
                    {prod.stock <= 2 && prod.stock > 0 && (
                      <div className="absolute top-3 right-3 bg-destructive px-2.5 py-1 rounded-full text-[10px] uppercase font-black tracking-wider text-white shadow-sm flex items-center gap-1">
                  ...
                  <div className="p-5 flex-1 flex flex-col justify-between space-y-4">
                    <div className="space-y-2">
                      ...
                      <div className="flex flex-wrap gap-2 pt-1">
                        ...
                        {prod.deposit ? (
                          <span className="px-2 py-0.5 bg-primary-light text-primary text-[10px] font-bold rounded-md border border-primary/10">
