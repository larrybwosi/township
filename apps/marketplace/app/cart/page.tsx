      ...
      {checkoutSuccess ? (
        <div className="max-w-2xl mx-auto bg-surface border border-green-200 rounded-xl p-8 text-center space-y-6 shadow-md my-10">
          ...
          <div className="pt-4 flex flex-col sm:flex-row gap-3 justify-center">
            <Link
              href="/orders"
              className="px-5 py-2.5 bg-emerald-500 hover:bg-emerald-400 text-black text-sm font-semibold rounded-lg transition"
            >
              Track Your Orders
            </Link>
            <Link
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-3 mt-1 text-xs font-bold">
                    <span className="text-emerald-500">${item.product.price} / item</span>
              ...
              <form onSubmit={handleCheckoutSubmit} className="space-y-4 text-xs font-bold">
                ...
                <div className="space-y-1">
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 border border-border rounded-lg bg-background text-foreground focus:outline-none focus:ring-1 focus:ring-emerald-500 font-normal"
                    required
                  />
                </div>
                ...
                <div className="bg-background border border-border rounded-lg p-4 space-y-2.5 mt-6 font-semibold">
                  ...
                  <div className="border-t border-border pt-2 flex justify-between text-base font-black text-emerald-500">
                ...
                <button
                  type="submit"
                  className="w-full py-3 bg-emerald-500 hover:bg-emerald-400 text-black text-xs font-black rounded-lg uppercase tracking-wider transition shadow-sm flex items-center justify-center gap-1.5"
                >
