...
export interface SanityProperty {
  ...
  address: string;
  category: "house" | "apartment_single" | "apartment_building" | "guesthouse" | "motel" | "hotel";
  townId: string;
  ownerId: string;
  amenities: string[];
  imageUrl: string;
...
const mockTowns: SanityTown[] = [
  { _id: "t-1", _type: "town", id: "t-1", name: "Greenwood", description: "A lush, peaceful suburb with beautiful parks and historic homes." },
  { _id: "t-2", _type: "town", id: "t-2", name: "Riverdale", description: "Vibrant riverside district featuring rich local culture and dining." },
  { _id: "t-3", _type: "town", id: "t-3", name: "Oakwood", description: "Upscale wooded neighborhood known for absolute tranquility and scenery." },
  { _id: "t-4", _type: "town", id: "t-4", name: "Lakeside", description: "Breathtaking views and cozy lakefront cabins perfect for weekend escapes." },
];
...
const mockProperties: SanityProperty[] = [
  ...
  },
  {
    ...
    townId: "t-2",
    ownerId: "u-2",
    amenities: ["Gym Access", "Wifi", "Elevator", "Secure Parking", "Concierge", "Pet Friendly"],
    ...
    units: [
      { id: "u-3-studio", name: "Studio Suite (102A)", price: 120, rooms: 1, description: "Compact studio suite overlooking the garden with a fully fitted kitchenette." },
      { id: "u-3-deluxe", name: "Deluxe 1-Bedroom (102B)", price: 180, rooms: 2, description: "Spacious 1-bedroom suite with a separate dining hall and private balcony." },
      { id: "u-3-penthouse", name: "Rooftop Penthouse (102C)", price: 350, rooms: 4, description: "Magnificent luxury penthouse with panoramic city & river views." },
    ],
  },
  {
    _id: "p-4",
  ...
  },
  {
    ...
    townId: "t-4",
    ownerId: "u-2",
    amenities: ["Pool", "Free Parking", "Wifi", "Cable TV", "Air Conditioning", "24/7 Desk"],
    ...
    units: [
      { id: "u-5-standard", name: "Standard Queen Room", price: 85, rooms: 1, description: "Comfortable room featuring one queen bed, refrigerator, and desk space." },
      { id: "u-5-double", name: "Double Double Room", price: 110, rooms: 2, description: "Spacious layout with two double beds, ideal for families or group travelers." },
    ],
  },
  {
    _id: "p-6",
    ...
    townId: "t-1",
    ownerId: "u-3",
    amenities: ["Spa", "Room Service", "Bar & Restaurant", "Wifi", "Air Conditioning", "Valet Parking", "Fitness Center"],
    ...
    units: [
      { id: "u-6-exec", name: "Executive King Suite", price: 250, rooms: 1, description: "Premium suite with king bed, marble bath, and dedicated work study." },
      { id: "u-6-presidential", name: "Presidential Suite", price: 600, rooms: 3, description: "Our grandest suite featuring personal butler service, dynamic acoustics, and unmatched views." },
    ],
  },
];
